...
test.describe('Handbook Layout', () => {
    test('handbook layout should load properly @demo', async ({ page }) => {
        ...
        await expect.soft(page.locator('article').filter({ hasText: 'Configurations 6 How To Get' }).getByRole('heading')).toBeVisible();
        ...
        await expect.soft(page.locator('article').filter({ hasText: 'Subscription 6 How To Get' }).getByRole('heading')).toBeVisible();
