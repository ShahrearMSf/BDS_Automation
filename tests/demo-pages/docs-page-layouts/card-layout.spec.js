...
test('test', async ({ page }) => {
  ...
  const seventhCategory = Heading.locator("a").nth(0);
  const eighthCategory = Heading.locator("a").nth(1);
  const ninthCategory = Heading.locator("a").nth(2);
  const tenththCategory = Heading.locator("a").nth(3);
  const twelvethCategoryCategory = Heading.locator("a").nth(4);
  const thirteenthCategory = Heading.locator("a").nth(5);
